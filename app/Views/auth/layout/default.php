...
<meta name="google-signin-client_id" content="108654679212-n7lnf1llqeib9oprnonske808906405k.apps.googleusercontent.com">
...
<!-- extend content ke view dinamis -->
<footer class="d-flex pb-3 pt-4 pt-md-4 border-top border-light bg-primary">
    <div class="container">
        <div class="row">
            <div class="col">
            <div class="d-flex text-center justify-content-center align-items-center" role="contentinfo">
                <p class="font-weight-normal font-small mb-0">Copyright © Themesberg
                    <span class="current-year"><?= date('Y'); ?></span>. Development by Zairi. Call me by whatsapp&nbsp;&nbsp;<a href="https://api.whatsapp.com/send?phone=6281318739245" target="_blank" class="btn btn-icon-only btn-pill btn-primary" aria-label="Whatsapp social link" data-toggle="tooltip" data-placement="top" title="" data-original-title="Call on Whatsapp">
                            <span aria-hidden="true" class="fab fa-whatsapp text-warning"></span>
                        </a></p>
                </div>
            </div>
        </div>
