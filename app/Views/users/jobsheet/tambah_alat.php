            ...
            <div class="col-md-12 col-lg-8 mt-3">
                ...
                <div class="card shadow-inset bg-primary border-light p-3 rounded">
                    <div class="card-body p-0">
                                <!-- Form Sakit -->
                                <form action="<?=site_url('/simpan-alat')?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                    <!-- Form-->
                                    <div class="form-group">
                                        <label for="alat">Alat<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control <?= $validation->hasError('alat') ? 'is-invalid' : null ?>" name="alat" id="alat" value="<?= old('alat') ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control <?= $validation->hasError('jumlah') ? 'is-invalid' : null ?>" name="jumlah" id="jumlah" value="<?= old('jumlah') ?>" required>
                                        <div class="invalid-feedback">
