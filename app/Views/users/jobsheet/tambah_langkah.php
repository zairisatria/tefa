            ...
            <div class="col-md-12 col-lg-8 mt-3">
                ...
                <div class="card shadow-inset bg-primary border-light p-3 rounded">
                    <div class="card-body p-0">
                                <!-- Form Sakit -->
                                <form action="<?=site_url('/simpan-langkah')?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                    <!-- Form-->
                                    <div class="form-group">
                                        <label for="langkah">Langkah<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control <?= $validation->hasError('langkah') ? 'is-invalid' : null ?>" name="langkah" id="langkah" value="<?= old('langkah') ?>" required>
