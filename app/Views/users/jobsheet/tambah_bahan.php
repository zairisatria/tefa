            ...
            <div class="col-md-12 col-lg-8 mt-3">
                ...
                <div class="card shadow-inset bg-primary border-light p-3 rounded">
                    <div class="card-body p-0">
                                <!-- Form Sakit -->
                                <form action="<?=site_url('/simpan-bahan')?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                    <!-- Form-->
                                    <div class="form-group">
                                        <label for="bahan">Bahan<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control <?= $validation->hasError('bahan') ? 'is-invalid' : null ?>" name="bahan" id="bahan" value="<?= old('bahan') ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= $validation->hasError('harga') ? 'is-invalid' : null ?>" name="harga" id="harga" value="<?= old('harga') ?>" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= $validation->hasError('jumlah') ? 'is-invalid' : null ?>" name="jumlah" id="jumlah" value="<?= old('jumlah') ?>" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" id="satuan" name="satuan" required>
                                            ...
                                            <option value="<?= $data['id']; ?>" <?php if (old('satuan') == $data['id']) {echo "selected";} ?> ><?= $data['satuan']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
