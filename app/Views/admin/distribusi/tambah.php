...
<?= $this->section('title') ?>
<title>Distribusi Produk - Tambah Distribusi Produk</title>
<?= $this->endSection() ?>
...
<div class="section-header">
  ...
  <div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">Tambah Distribusi Produk</div>
  </div>
</div>
<div class="section-body">
	<div class="row">
	  <div class="col-md-12">
          <!-- Content Card -->
          <form method="POST" action="<?=site_url('/simpan-distribusi')?>" enctype="multipart/form-data">
          <?= csrf_field() ?>
            <div class="card">
              <div class="card-body">
                <!-- Form -->
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <select class="select2 my-1 mr-sm-2" name="id_proposal" id="id_proposal" required>
                      ...
                      <option value="<?= $data['id']; ?>" <?php if (old('id_proposal') == $data['id']) {echo "selected";} ?> ><?= $data['judul']; ?></option>
                      <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <select class="select2 my-1 mr-sm-2" name="id_toko" id="id_toko" required>
                      ...
                      <option value="<?= $data['id']; ?>" <?php if (old('id_toko') == $data['id']) {echo "selected";} ?> ><?= $data['nama']; ?></option>
                      <?php endforeach; ?>
                    </select>
                    <div class="invalid-feedback">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="harga_jual" id="harga_jual" value="<?= old('harga_jual') ?>" placeholder="Rp ..." required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="jumlah" id="jumlah" value="<?= old('jumlah') ?>" placeholder="Jumlah Produk" required>
                    <div class="invalid-feedback">
