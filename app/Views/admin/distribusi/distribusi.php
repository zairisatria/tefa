...
<div class="section-body">
	<div class="row">
      ...
      <div class="card-header">
          <h4><a href="<?=site_url('tambah-distribusi')?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a></h4>
          ...
          <div class="table-responsive">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td><?= $data['judul']; ?></td>
                  <td><?= $data['nama']; ?></td>
                  <td class="text-right"> <?= 'Rp '.number_format($data['harga_jual'],2); ?></td>
                  <td class="text-right"> <?= $data['jumlah']; ?></td>
                  <td class="text-center">
                    <a class="btn btn-outline-info btn-sm" href="<?=base_url()?>/edit-distribusi/<?= $data['id']; ?>"><i class="fas fa-edit"></i></a>
                    <a class="btn btn-outline-danger btn-sm" href="<?=base_url()?>/delete-distribusi/<?= $data['id']; ?>" id="tombol_hapus"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
