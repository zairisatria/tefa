...
<div class="section-body">
	<div class="row">
	  <div class="col-md-12">
      <!-- Content Card -->
      <form method="POST" action="<?=site_url('/simpan-prodi')?>" enctype="multipart/form-data">
      <?= csrf_field() ?>
        <div class="card">
          <div class="card-body">
            <!-- form -->
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" name="prodi" class="form-control <?= $validation->hasError('prodi') ? 'is-invalid' : null ?>" id="prodi" value="<?= old('prodi') ?>" placeholder="Tulis Program Studi" required="">
