...
<div class="section-body">
	<div class="row">
      ...
      <div class="card-header">
        <h4><a href="<?=site_url('tambah-prodi')?>" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah</a></h4>
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-outline-info btn-sm" href="<?=base_url()?>/edit-prodi/<?= $data['id']; ?>"><i class="fas fa-edit"></i></a>
                    <a class="btn btn-outline-danger btn-sm" href="<?=base_url()?>/delete-prodi/<?= $data['id']; ?>" id="tombol_hapus"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
