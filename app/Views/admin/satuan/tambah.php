...
<div class="section-body">
	<div class="row">
	  <div class="col-md-12">
      <!-- Content Card -->
      <form method="POST" action="<?=site_url('/simpan-satuan')?>" enctype="multipart/form-data">
      <?= csrf_field() ?>
        <div class="card">
          <div class="card-body">
            <!-- form -->
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" name="satuan" class="form-control <?= $validation->hasError('satuan') ? 'is-invalid' : null ?>" id="satuan" value="<?= old('satuan') ?>" placeholder="Tulis satuan" required="">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" name="konversi_satuan" class="form-control <?= $validation->hasError('konversi_satuan') ? 'is-invalid' : null ?>" id="konversi_satuan" value="<?= old('konversi_satuan') ?>" placeholder="Tulis konversi satuan" required="">
                <div class="invalid-feedback">
            ...
            <!-- End Form -->
             ...
             <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="number" min="0" name="nilai_konversi" class="form-control <?= $validation->hasError('nilai_konversi') ? 'is-invalid' : null ?>" id="nilai_konversi" value="<?= old('nilai_konversi') ?>" placeholder="Tulis nilai konversi" required="">
                <div class="invalid-feedback">
