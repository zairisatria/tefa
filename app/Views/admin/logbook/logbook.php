                            ...
                            <thead>
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  <a class="btn btn-sm btn-outline-info" href="<?=base_url()?>/detail-logbook-kelompok/<?= $data['id_kelompok']; ?>"><i class="fas fa-arrow-circle-right"></i></a>
                                </td>
                                <td class="text-center">
                                  <a class="btn btn-sm btn-outline-info" target="_blank" href="<?=base_url()?>/logbook-pdf/<?= $data['id_kelompok']; ?>"><i class="fas fa-arrow-circle-right"></i></a>
                                </td>
                              </tr>
                              <?php endforeach; ?>
                              </tbody>
